...
export default function Nav() {
  ...
  return (
    <div className="sticky top-0 z-50 p-1 mx-2 md:mx-10 max-w-full ">
      <nav
        className="bg-[#8A0000]/80 backdrop-blur-3xl border-b border-red-200/10
 rounded-2xl drop-shadow-xl p-3 flex justify-between items-center shadow-md"
      >
        ...
        <ul className="space-x-4 hidden md:flex font-pop">
          ...
          <li>
            <Link href="/Manga" className="text-white hover:text-gray-300">
              Manga
            </Link>
          </li>
        </ul>
        <div className="flex items-center space-x-4 pr-2">
          {!session && (
            <button
              className=" bg-slate-200 text-red-900 font-pop p-2 rounded-md text-sm hover:bg-gray-200 "
              onClick={() => {
                router.push("/Login");
              }}
            >
          ...
          <button
            className=" text-white rounded-md h-8 md:h- "
